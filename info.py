...
USERNAME = environ.get('USERNAME', "https://t.me/Abdulla_790") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004379166444'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+sGOpAlm-4Lc1YzQ1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004480503690']
#---------------------------------------------------------------
#---------------------------------------------------------------
